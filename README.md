## Computer Vision with [Maté 🧉](https://github.com/ilex-paraguariensis/yerbamate/tree/lightning) [PyTorch Lightning⚡](https://github.com/Lightning-AI/lightning) [huggingface vision 🤗](https://github.com/huggingface/transformers) 
